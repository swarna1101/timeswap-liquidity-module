# Liquidity Mining Module based on Uniswap v3
...
- `nonfungiblePositionManager.safeTransferFrom(sender, this, tokenId)`
    - This transfer triggers the onERC1155Received hook

### `onERC1155Received(address, address from, uint256 tokenId, bytes calldata data)`

**Check:**

- Make sure sender is univ3
...
To unstake , you call `unstakeToken`, which takes all the same arguments as `stake`.
